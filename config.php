...
return array(
	...
	'show_birth_first_image' => true, // Whether to show birth first image of individuals
	...
	'show_death_first_image' => true, // Whether to show death first image of individuals
	'show_burial_date' => true, // Whether to show burial date  for individuals
	'burial_date_year_only' => false, // Whether to show just the year or the full GEDCOM date pf burial
	'show_burial_place' => true, // Whether to show burial date for individuals
	'show_burial_first_image' => true, // Whether to show burial first image of individuals
	...
	'show_marriage_first_image' => true, // Whether to show marriage first image of individuals
	...
	'show_marriage_type' => true, // Whether to show the type of marriage on the family record
	'show_marriage_type_not_specified' => true, // Whether to add an "Unknown marriage type" message to the family record if 'show_marriage_type' is active and the type was not specified in the record
