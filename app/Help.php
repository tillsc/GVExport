...
class Help
{
    ...
    public function __construct()
    {
        ...
        $this->help[13][0] = "Add photos";
        $this->help[13][1] = "Whether to display the photo from the individual's page in the tree. This is only supported for Decorated and Combined diagram types.";
