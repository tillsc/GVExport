...
class Settings
{
    ...
    public function __construct(){
        ...
        $this->defaultSettings['indi_display_sex_options'] = [self::OPTION_SEX_COLOURED_BORDER => "Coloured border", self::OPTION_SEX_TEXT => "Text", self::OPTION_SEX_NONE => "Don't display sex"];
